...
Operators work from a review queue (email), a reply queue, and an Instagram DM queue, approving sends from the web app or via Telegram. Admins manage business lines, catalogue, templates, targeting, batch history, and user accounts.
